    ...
    >
      ...
      <div class="embed">
        ...
        <div class="main-row">
          ...
          <v-toolbar-title>
            <nuxt-link to="/" class="btn-c-o"><span class="ersteSpan white--text qs">COMPANY LOGO</span></nuxt-link>
          </v-toolbar-title>
          <v-spacer />
...
export default {
    ...
    mounted(){
      this.height = window.innerHeight * 0.19;
    }
}
</script>
