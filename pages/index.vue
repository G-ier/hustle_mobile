<template>
  <div class="homepage">
          ...
          <div class="explain">
            ...
            >
              ...
              <v-list-item-content>
                ...
                <v-list-item-subtitle class="secondary--text">Skrrrrrrrrrrr</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item> 
            <v-list-item
            >
      ...
      <div class="main-side">
        ...
        <div class="products-main">
          <div class="product-main">
            <img class="product-main-image" src="https://images.pexels.com/photos/7214835/pexels-photo-7214835.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="iphone">
          ...
          <div class="product-main">
            <img class="product-main-image" src="https://images.pexels.com/photos/3707744/pexels-photo-3707744.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="iphone">
            <div class="product-main-desc">
              <h3 class="qs secondary--text">Product title</h3>
              <v-rating 
              v-model="ratingsfake" 
    ...
    <div class="contact">
      <h1 class="con-title">For the people!</h1>
...
.likkle-div{
  height: 400px;
  display: grid;
  grid-template-rows: 270px 120px;
  grid-row-gap: 10px;
}
.likkle-1{
  height: 270px;
