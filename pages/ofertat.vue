    ...
    <div class="shop">
        ...
        >
            ...
            <div class="sidebar sidebar-side">
               <div class="sidebar-links mb-4 mt-1">
                   <h4 class="qs secondary--text ma-0 pa-0">Oferta te nxehta</h4>
        ...
        <div class="tracks">
            <div class="tracky">
                ...
                <p class="qs s12 secondary--text pa-0 ma-0 ml-1"> oferta te nxehta</p>
            </div>
        </div>
...
export default {
    async asyncData(){
        const pageData = await firebase.firestore().collection('elektronike').orderBy("details.priceLow").orderBy("details.likes").startAt(0).limit(6).get();
    ...
    methods: {
        loadMore: async function(){
            const pageData2 = await firebase.firestore().collection('elektronike').orderBy("details.priceLow").orderBy("details.likes").startAt(this.last).limit(6).get();
