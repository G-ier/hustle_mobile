    ...
    <div class="shop">
        ...
        >
            ...
            <div class="sidebar sidebar-side">
               <div class="sidebar-links mb-4 mt-1">
                   <h4 class="qs secondary--text ma-0 pa-0">Mobilje & Shtepiake</h4>
                   <div class="sideline"></div>
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/mobilje/dysehk/">Dyshek & sanitare</nuxt-link>
                       <v-icon color="secondary" size="20">mdi-arrow-right-drop-circle</v-icon>
                   </div>
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/mobilje/kuzhina/">Kuzhina</nuxt-link>
                       <v-icon color="secondary" size="20">mdi-arrow-right-drop-circle</v-icon>
                   </div>
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/mobilje/outdoor/">Kopsht & Outdoor</nuxt-link>
                       <v-icon color="secondary" size="20">mdi-arrow-right-drop-circle</v-icon>
                   </div>
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/mobilje/kafshesh/">Produkte Kafshesh</nuxt-link>
                       <v-icon color="secondary" size="20">mdi-arrow-right-drop-circle</v-icon>
                   </div>
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/mobilje/vegla/">Vegla</nuxt-link>
                       <v-icon color="secondary" size="20">mdi-arrow-right-drop-circle</v-icon>
                   </div>
               </div>
        ...
        <div class="tracks">
            <div class="tracky">
                ...
                <p class="qs s12 secondary--text pa-0 ma-0 ml-1"> Moilje shtepiake</p>
            </div>
        </div>
        <div class="market-new mb-3">
           <div class="sidebar">
               <div class="sidebar-links mb-4">
                   <h4 class="qs secondary--text ma-0 pa-0">Mobilje</h4>
                   <div class="sideline"></div>
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/mobilje/dyshek/">Dyshek & sanitare</nuxt-link>
                       <v-icon color="secondary" size="20">mdi-arrow-right-drop-circle</v-icon>
                   </div>
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/mobilje/kuzhina/">Kuzhina</nuxt-link>
...
export default {
    async asyncData(){
        const pageData = await firebase.firestore().collection('elektronike').where("details.kategoria", "==", "Mobilje Shtepie").orderBy("details.likes").startAt(0).limit(6).get();
            ...
            meta: [
                {
                    hid: 'description',
                    name: 'description',
                    content: 'Produkte mobilare me cmime konkurruese'
                }
            ]
        }
    },
    ...
    methods: {
        loadMore: async function(){
            const pageData2 = await firebase.firestore().collection('elektronike').where("details.kategoria", "==", "Mobilje Shtepie").orderBy("details.likes").startAt(this.last).limit(6).get();
