    ...
    <div class="shop">
        ...
        <div class="tracks">
            <div class="tracky">
                ...
                <p class="qs s12 secondary--text pa-0 ma-0 ml-1"> Kopsht & Outdoor</p>
            </div>
        </div>
        <div class="market-new mb-3">
           <div class="sidebar">
               <div class="sidebar-links mb-4">
                   ...
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/mobilje/dyshek/">Dyshek & Outdoor</nuxt-link>
                       <v-icon color="secondary" size="20">mdi-arrow-right-drop-circle</v-icon>
                   </div>
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/mobilje/kafshesh/">Produkte Kafshesh</nuxt-link>
...
export default {
    async asyncData(){
        const pageData = await firebase.firestore().collection('elektronike').where("details.kategoria", "==", "Kopesht & Outdoor").orderBy("details.likes").startAt(0).limit(6).get();
    ...
    head(){
        return{
            title: 'Kopsht & Outdoor',
            meta: [
                {
                    hid: 'description',
                    name: 'description',
                    content: 'Produkte per kopshtin dhe outdoor me cmime konkurruese'
                }
            ]
        }
    },
    ...
    methods: {
        loadMore: async function(){
            const pageData2 = await firebase.firestore().collection('elektronike').where("details.kategoria", "==", "Kopesht & Outdoor").orderBy("details.likes").startAt(this.last).limit(6).get();
