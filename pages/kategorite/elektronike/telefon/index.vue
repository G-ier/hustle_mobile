    ...
    <div class="shop">
        ...
        >
            ...
            <div class="sidebar sidebar-side">
               <div class="sidebar-links mb-4 mt-1">
                   ...
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/elektronike/kamera">Kamera & Photo</nuxt-link>
                       <v-icon color="secondary" size="20">mdi-arrow-right-drop-circle</v-icon>
                   </div>
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/elektronike/video-lojra">Video games</nuxt-link>
                       <v-icon color="secondary" size="20">mdi-arrow-right-drop-circle</v-icon>
                   </div>
               </div>
        ...
        <div class="tracks">
            <div class="tracky">
                ...
                <p class="qs s12 secondary--text pa-0 ma-0 ml-1"> Telefona & Aksesore</p>
            </div>
        </div>
...
export default {
    async asyncData(){
        const pageData = await firebase.firestore().collection('elektronike').where("details.kategoria", "==", "Telefon & Aksesore").orderBy("details.likes").startAt(0).limit(6).get();
    ...
    head(){
        return{
            title: 'Telefon dhe aksesore',
            meta: [
                {
                    hid: 'description',
                    name: 'description',
                    content: 'Telefon dhe aksesore me cmime konkurruese'
                }
            ]
        }
    },
    ...
    methods: {
        loadMore: async function(){
            const pageData2 = await firebase.firestore().collection('elektronike').where("details.kategoria", "==", "Telefon & Aksesore").orderBy("details.likes").startAt(this.last).limit(6).get();
