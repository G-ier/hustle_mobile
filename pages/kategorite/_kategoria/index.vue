    ...
    <div class="shop">
        ...
        <div class="tracks">
            <div class="tracky">
                ...
                <p class="qs s12 secondary--text pa-0 ma-0 ml-1"> {{nameting}}</p>
            </div>
        </div>
        <div class="market-new mb-3">
           <div class="sidebar">
               ...
               <div class="sidebar-links mb-4">
                   <v-col class="my-4">
                        <v-btn small class="white--text mb-4" color="secondary" @click="applyFilters">Apliko filtrin</v-btn>
                        <v-btn small class="white--text mb-4" color="secondary" @click="resetFilter">Reset</v-btn>
                        <p class="qs secondary--text">Zgjidh filtrat dhe aplikoji</p>
                    </v-col>
                   <div class="sidebar-valuator mt-6" v-for="filter in dumb" :key="filter.id">
...
export default {
    ...
    async asyncData({$axios, route}){
        ...
        //const data = await $axios.post('http://127.0.0.1:5000/products_and_filters', null, {
        //    params: {
        //        category: katrequest,
        //        last: 9
        //    },
        ...
        const data = await $axios({
            method: "post",
            url: "http://127.0.0.1:5000/products_and_filters",
            params: {
                category: katrequest,
                last: 9
            },
            ...
            meta: [
                {
                    hid: 'description',
                    name: 'description',
                    content: 'Gjerat t emira te bukra tek ne'
                }
            ]
        }
    },
