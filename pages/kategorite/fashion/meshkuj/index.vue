    ...
    <div class="shop">
        ...
        >
            ...
            <div class="sidebar sidebar-side">
               <div class="sidebar-links mb-4 mt-1">
                   <h4 class="qs secondary--text ma-0 pa-0">Fashion</h4>
                   <div class="sideline"></div>
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/fashion/femra/">Rroba femrash</nuxt-link>
        ...
        <div class="tracks">
            <div class="tracky">
                ...
                <p class="qs s12 secondary--text pa-0 ma-0 ml-1"> Outlet meshkujsh</p>
            </div>
        </div>
...
export default {
    async asyncData(){
        const pageData = await firebase.firestore().collection('elektronike').where("details.kategoria", "==", "Rroba meshkujsh").orderBy("details.likes").startAt(0).limit(6).get();
    ...
    head(){
        return{
            title: 'Rroba meshkujsh',
            meta: [
                {
                    hid: 'description',
                    name: 'description',
                    content: 'Rroba meshkujsh me cmime konkurruese'
                }
            ]
        }
    },
    ...
    methods: {
        loadMore: async function(){
            const pageData2 = await firebase.firestore().collection('elektronike').where("details.kategoria", "==", "Rroba meshkujsh").orderBy("details.likes").startAt(this.last).limit(6).get();
