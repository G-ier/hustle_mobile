    ...
    <div class="shop">
            ...
            <div class="sidebar sidebar-side">
               <div class="sidebar-links mb-4 mt-1">
                   ...
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/fashion/meshkuj/">Rroba meshkujsh</nuxt-link>
        ...
        <div class="tracks">
            <div class="tracky">
                ...
                <p class="qs s12 secondary--text pa-0 ma-0 ml-1"> Outlet femrash</p>
            </div>
        </div>
...
export default {
    async asyncData(){
        const pageData = await firebase.firestore().collection('elektronike').where("details.kategoria", "==", "Rroba femrash").get();
            ...
            meta: [
                {
                    hid: 'description',
                    name: 'description',
                    content: 'Rroba femrash me cmime konkurruese'
                }
            ]
        }
    },
