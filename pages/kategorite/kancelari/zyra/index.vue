    ...
    <div class="shop">
        ...
        >
            ...
            <div class="sidebar sidebar-side">
               <div class="sidebar-links mb-4 mt-1">
                   <h4 class="qs secondary--text ma-0 pa-0">Kancelari</h4>
                   <div class="sideline"></div>
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/kancelari/projektor/">Projektore</nuxt-link>
                       <v-icon color="secondary" size="20">mdi-arrow-right-drop-circle</v-icon>
                   </div>
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/kancelari/printer/">Printer</nuxt-link>
                       <v-icon color="secondary" size="20">mdi-arrow-right-drop-circle</v-icon>
                   </div>
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/kancelari/shkollore/">Produkte shkolore</nuxt-link>
                       <v-icon color="secondary" size="20">mdi-arrow-right-drop-circle</v-icon>
                   </div>
               </div>
        ...
        <div class="tracks">
            <div class="tracky">
                ...
                <p class="qs s12 secondary--text pa-0 ma-0 ml-1"> Produkte zyrash</p>
            </div>
        </div>
        <div class="market-new mb-3">
           <div class="sidebar">
               <div class="sidebar-links mb-4">
                   ...
                   <div class="sidebar-link">
                       <nuxt-link class="qs secondary--text btn-c-o ma-0 pa-0" to="/kategorite/kancelari/shkollore/">Produkte shkollore</nuxt-link>
                       <v-icon color="secondary" size="20">mdi-arrow-right-drop-circle</v-icon>
                   </div>
               </div>
               <div class="sidebar-links mb-4">
...
export default {
    async asyncData(){
        const pageData = await firebase.firestore().collection('elektronike').where("details.kategoria", "==", "Produkte Zyrash").orderBy("details.likes").startAt(0).limit(6).get();
    ...
    head(){
        return{
            title: 'Produkte Zyrash',
            meta: [
                {
                    hid: 'description',
                    name: 'description',
                    content: 'Produkte zyrash me cmime konkurruese'
                }
            ]
        }
    },
    ...
    methods: {
        loadMore: async function(){
            const pageData2 = await firebase.firestore().collection('elektronike').where("details.kategoria", "==", "Produkte Zyrash").orderBy("details.likes").startAt(this.last).limit(6).get();
