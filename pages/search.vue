    ...
    <div class="shop">
        ...
        <div class="tracks">
            <div class="tracky">
                ...
                <p class="qs s12 secondary--text pa-0 ma-0 ml-1"> Kerkimi: {{route}}</p>
            </div>
        </div>
...
export default {
    async asyncData({route, $axios}){
        ...
        var obj = await $axios({
            method: "post",
            url: "http://91.230.254.11:3333/search_click",
            params: {
                query_text: route.query.search,
                query_product: 9
            },
    ...
    methods: {
        ...
        async checkBox(value, emri){
            ...
            var obj  = await this.$axios({
                method: "post",
                url: "http://91.230.254.11:3333/filter_redirect",
                data: bodyFormData,
                headers:{
