...
export default {
    async asyncData(){
        const pageData = await firebase.firestore().collection('elektronike').orderBy("details.price").startAt(0).limit(6).get();
    ...
    methods: {
        loadMore: async function(){
            const pageData2 = await firebase.firestore().collection('elektronike').orderBy("details.price").startAt(this.last).limit(6).get();
